...
- \usepackage{tipa}
   ...
   \fancyhead[C]{\Large\bfseries\color{headergrey}Data}
...
```{r}
ifri_car_liv <- get_csv("ifri_car_liv.csv")
...
```{r}
ifir <- get_strata('ifri_car_liv.dta')
str(ifir)
```

Search World Development Indicators
